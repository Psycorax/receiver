...
append Units {
    ...
    {AlteraCycloneV HPSComputerMin Inst}
...
append BhvUnits {
    ...
    {WavFile WavToPar Bhv}
    {WavFile WavToI2s Bhv}
    {WavFile ParToWav Bhv}
}
...
append ForeignUnits {
    ...
    {AlteraCycloneV HPSComputerMin Computer_System/synthesis/Computer_System.qip 0 QIP}
}
...
# HPS
# (Note: Pins locations are implicitly assigned)
append Pins {
    {HPS_DDR3_ADDR[*]  {} 0 "SSTL-15 Class I" { {CURRENT_STRENGTH_NEW "MAXIMUM CURRENT"} {PACKAGE_SKEW_COMPENSATION OFF} }}
    {HPS_DDR3_BA[*]    {} 0 "SSTL-15 Class I" { {CURRENT_STRENGTH_NEW "MAXIMUM CURRENT"} {PACKAGE_SKEW_COMPENSATION OFF} }}
    {HPS_DDR3_CAS_N    {} 0 "SSTL-15 Class I" { {CURRENT_STRENGTH_NEW "MAXIMUM CURRENT"} {PACKAGE_SKEW_COMPENSATION OFF} }}
    {HPS_DDR3_CK_N     {} 0 "Differential 1.5-V SSTL Class I" { {D5_DELAY 2} {OUTPUT_TERMINATION "SERIES 50 OHM WITHOUT CALIBRATION"} {PACKAGE_SKEW_COMPENSATION OFF} }}
    {HPS_DDR3_CK_P     {} 0 "Differential 1.5-V SSTL Class I" { {D5_DELAY 2} {OUTPUT_TERMINATION "SERIES 50 OHM WITHOUT CALIBRATION"} {PACKAGE_SKEW_COMPENSATION OFF} }}
    {HPS_DDR3_CKE      {} 0 "SSTL-15 Class I" { {CURRENT_STRENGTH_NEW "MAXIMUM CURRENT"} {PACKAGE_SKEW_COMPENSATION OFF} }}
    {HPS_DDR3_CS_N     {} 0 "SSTL-15 Class I" { {CURRENT_STRENGTH_NEW "MAXIMUM CURRENT"} {PACKAGE_SKEW_COMPENSATION OFF} }}
    {HPS_DDR3_DM[*]    {} 0 "SSTL-15 Class I" { {OUTPUT_TERMINATION "SERIES 50 OHM WITH CALIBRATION"} {PACKAGE_SKEW_COMPENSATION OFF} }}
    {HPS_DDR3_DQ[*]    {} 0 "SSTL-15 Class I" { {INPUT_TERMINATION "PARALLEL 50 OHM WITH CALIBRATION"} {OUTPUT_TERMINATION "SERIES 50 OHM WITH CALIBRATION"} {PACKAGE_SKEW_COMPENSATION OFF} }}
    {HPS_DDR3_DQS_N[*] {} 0 "Differential 1.5-V SSTL Class I" { {INPUT_TERMINATION "PARALLEL 50 OHM WITH CALIBRATION"} {OUTPUT_TERMINATION "SERIES 50 OHM WITH CALIBRATION"} {PACKAGE_SKEW_COMPENSATION OFF} }}
    {HPS_DDR3_DQS_P[*] {} 0 "Differential 1.5-V SSTL Class I" { {INPUT_TERMINATION "PARALLEL 50 OHM WITH CALIBRATION"} {OUTPUT_TERMINATION "SERIES 50 OHM WITH CALIBRATION"} {PACKAGE_SKEW_COMPENSATION OFF} }}
    {HPS_DDR3_ODT      {} 0 "SSTL-15 Class I" { {CURRENT_STRENGTH_NEW "MAXIMUM CURRENT"} {PACKAGE_SKEW_COMPENSATION OFF} }}
    {HPS_DDR3_RAS_N    {} 0 "SSTL-15 Class I" { {CURRENT_STRENGTH_NEW "MAXIMUM CURRENT"} {PACKAGE_SKEW_COMPENSATION OFF} }}
    {HPS_DDR3_RESET_N  {} 0 "SSTL-15 Class I" { {CURRENT_STRENGTH_NEW "MAXIMUM CURRENT"} {PACKAGE_SKEW_COMPENSATION OFF} }}
    {HPS_DDR3_RZQ      {} 0 "SSTL-15 Class I" {}}
    {HPS_DDR3_WE_N     {} 0 "SSTL-15 Class I" { {CURRENT_STRENGTH_NEW "MAXIMUM CURRENT"} {PACKAGE_SKEW_COMPENSATION OFF} }}
    {HPS_ENET_*        {} 0 "3.3-V LVTTL"}
    {HPS_FLASH_*       {} 0 "3.3-V LVTTL"}
    {HPS_I2C_CONTROL   {} 0 "3.3-V LVTTL"}
    {HPS_I2C1_*        {} 0 "3.3-V LVTTL"}
    {HPS_I2C2_*        {} 0 "3.3-V LVTTL"}
    {HPS_SD_*          {} 0 "3.3-V LVTTL"}
    {HPS_USB_*         {} 0 "3.3-V LVTTL"}
    {HPS_CONV_USB_N    {} 0 "3.3-V LVTTL"}
    {HPS_SPIM_*        {} 0 "3.3-V LVTTL"}
    {HPS_UART_*        {} 0 "3.3-V LVTTL"}
    {HPS_KEY           {} 0 "3.3-V LVTTL"}
    {HPS_LED           {} 0 "3.3-V LVTTL"}
    {HPS_LTC_GPIO      {} 0 "3.3-V LVTTL"}
    {HPS_GSENSOR_INT   {} 0 "3.3-V LVTTL"}
}
