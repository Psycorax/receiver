...
fprintf('scd2_3 : lowpass filter design \n')
...
FIG1 = figure('Name','scd2_2 : IIR filt design (MATLAB)',...
...
FIG2 = figure('Name','scd2_2 : Quantization for direct form implementation',...
  'NumberTitle','off','Units','normal','Position',[.54 .40 .45 .55]);
...
for m=1:L
  ...
  if m==1
      FIG3 = figure('Name',['scd2_3 : IIR filt design (cascade form : ',num2str(B),...
...
FIG4 = figure('Name',['scd2_3 : IIR filt design (cascade form : ',num2str(B),' bits )'],...
...
% Graphics
FIG4 = figure('Name',['scd2_3 : Original design (blue), direct impl. form (green), cascade form (black)'],...
  'NumberTitle','off','Units','normal','Position',[.54 .31 .45 .55]);
subplot(211)
