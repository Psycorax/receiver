...
grpdelay_bp = grpdelay(bp_fo,1);
grpdelay_tp = grpdelay(tp,1);
...
data_transmit = [1,0,1,1,0];%round(rand(1,N));
...
r_u = filter(bp_fu,1,r);
r_o = filter(bp_fo,1,r);
